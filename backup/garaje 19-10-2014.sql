...
CREATE TABLE `testacionamiento` (
  ...
  KEY `fk_tEstacionamiento_tReserva1_idx` (`IdReserva`),
  ...
  CONSTRAINT `fk_tEstacionamiento_tReserva1` FOREIGN KEY (`IdReserva`) REFERENCES `treserva` (`IdReserva`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- ----------------------------
-- Table structure for `treserva`
-- ----------------------------
DROP TABLE IF EXISTS `treserva`;
CREATE TABLE `treserva` (
  `IdReserva` int(11) NOT NULL,
  `FechaReserva` date NOT NULL,
  `FechaIngresoReserva` date NOT NULL,
  `IdPersona` int(11) DEFAULT NULL,
  PRIMARY KEY (`IdReserva`),
  KEY `fk_tReserva_tPersona1_idx` (`IdPersona`),
  CONSTRAINT `fk_tReserva_tPersona1` FOREIGN KEY (`IdPersona`) REFERENCES `tpersona` (`IdPersona`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
